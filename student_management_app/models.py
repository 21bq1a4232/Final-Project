...
class FaceEncoding(models.Model):
    ...
    def __str__(self):
        return f"Face encoding for {self.user.username if self.user else 'Unknown User'}"

class SessionYearModel(models.Model):
    id = models.AutoField(primary_key=True)
    session_start_year = models.DateField()
    session_end_year = models.DateField()
    created_by = models.ForeignKey(CustomUser, on_delete=models.DO_NOTHING, related_name='session_years_created', null=True, blank=True)
...
class Staffs(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    created_by = models.ForeignKey(CustomUser, on_delete=models.DO_NOTHING, related_name='staffs_created', null=True, blank=True)
    objects = models.Manager()
...
class Courses(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    created_by = models.ForeignKey(CustomUser, on_delete=models.DO_NOTHING, related_name='courses_created', null=True, blank=True)
    objects = models.Manager()
...
class Subjects(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    created_by = models.ForeignKey(CustomUser, on_delete=models.DO_NOTHING, related_name='subjects_created', null=True, blank=True)
    objects = models.Manager()
...
class FeesStructure(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    created_by = models.ForeignKey(CustomUser, on_delete=models.DO_NOTHING, related_name='fees_structure_created', null=True, blank=True)
